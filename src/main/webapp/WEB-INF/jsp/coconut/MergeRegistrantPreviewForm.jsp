...
<head>
	...
	<title>Merge Registrant - Preview</title>
</head>
<body>
<div class="wrapper">
	<jsp:include page="PageHeader.jsp"></jsp:include>
	<jsp:include page="RegistrantSubNav.jsp" />
	<s:form action="coconut/mergeRegistrantProcess">
	<div id="content_wrapper">
		...
		<div id="primary_content">
			...
			<input type="submit" accesskey="P" value="Merge these registrants" class="button">
